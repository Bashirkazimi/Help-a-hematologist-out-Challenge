...
from data import create_dataset, get_input_dataset, get_input_dataset_mean_std
...
if __name__ == '__main__':
    ...
    dataset = get_input_dataset_mean_std('metadata.csv', batch_size=opt.batch_size, num_workers=opt.num_threads, inputWBC=opt.inputWBC)
